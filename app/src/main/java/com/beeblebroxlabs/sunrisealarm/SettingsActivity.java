...
//      bindPreferenceSummaryToValue(findPreference("example_list"));
      button = findPreference("updateLocationButton");
      sharedPreferences = getActivity().getApplicationContext().getSharedPreferences("myPref",MODE_PRIVATE);
      cityName = sharedPreferences.getString("cityName"," ");

//      button.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
//        @Override
//        public boolean onPreferenceClick(Preference preference) {
//          Toast.makeText(getActivity().getApplicationContext(), "Update Location...", Toast.LENGTH_SHORT).show();
//          Log.e("ERROR:","Update Button");
//          return true;
//        }
//      });
...
//    public void onCreate(Bundle savedInstanceState) {
//      super.onCreate(savedInstanceState);
//      addPreferencesFromResource(R.xml.pref_notification_bkp);
//      setHasOptionsMenu(true);
//
//      // Bind the summaries of EditText/List/Dialog/Ringtone preferences
//      // to their values. When their values change, their summaries are
...
//    public void onCreate(Bundle savedInstanceState) {
//      super.onCreate(savedInstanceState);
//      addPreferencesFromResource(R.xml.pref_data_sync_bkp);
//      setHasOptionsMenu(true);
//
//      // Bind the summaries of EditText/List/Dialog/Ringtone preferences
//      // to their values. When their values change, their summaries are
